...
import { CheckCircleSolid, CircleDottedLine, CircleHalfSolid } from '@flowind/icons';
...
const ProgressTabsRoot = (props: ProgressTabsPrimitives.TabsProps) => (
  <ProgressTabsPrimitives.Root {...props} />
);
...
>(({ className, ...props }, ref) => (
  <ProgressTabsPrimitives.Content ref={ref} className={clx('outline-none', className)} {...props} />
));
