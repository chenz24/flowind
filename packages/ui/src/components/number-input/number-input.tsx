...
import { assignRef, clamp, useMergedRef, useOs } from '@flowind/hooks';
import { DefaultProps, getSize, rem, Selectors, useComponentDefaultProps } from '@/styles';
...
export const NumberInput = forwardRef<HTMLInputElement, NumberInputProps>((props, ref) => {
  ...
  const controls = (
    <div className={classes.rightSection}>
      <button
        ...
        tabIndex={-1}
        aria-hidden
        // @ts-expect-error ignore this event type
  ...
  return (
    <TextInput
      ...
      size={size}
      styles={styles}
      classNames={{ ...classNames, addonAfter: classes.addonAfter }}
