...
import { getSelectRightSectionProps } from '../select/select-right-section/get-select-right-section-props';
...
import { DefaultValue, DefaultValueStylesNames } from './default-value/default-value';
