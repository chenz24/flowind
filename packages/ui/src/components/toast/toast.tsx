...
>(({ className, ...props }, ref) => (
  <Primitives.Viewport
    ref={ref}
    className={clx('fixed right-0 top-0 z-[9999] w-full p-6 md:max-w-[484px]', className)}
    {...props}
  />
));
 ...
 * @excludeExternal
 */
const Toast = React.forwardRef<React.ElementRef<typeof Primitives.Root>, ToastProps>(
  (
    {
      className,
      /**
