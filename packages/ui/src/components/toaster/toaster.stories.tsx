    ...
    return (
      <div className="size-full">
        <div className="flex flex-col gap-y-2">
          <Button size="sm" type="secondary" onClick={makeMessageToast}>
            Make message toast
          </Button>
          <Button size="sm" type="secondary" onClick={makeInfoToast}>
            Make info toast
          </Button>
          <Button size="sm" type="secondary" onClick={makeSuccessToast}>
            Make success toast
          </Button>
          <Button size="sm" type="secondary" onClick={makeWarningToast}>
            Make warning toast
          </Button>
          <Button size="sm" type="secondary" onClick={makeErrorToast}>
            Make error toast
          </Button>
          <Button size="sm" type="secondary" onClick={makeActionToast}>
            Make action toast
          </Button>
          <Button size="sm" type="secondary" onClick={makeUpdatingToast}>
            Make toast
          </Button>
          <Button size="sm" type="secondary" onClick={makeAsyncToast}>
            Make async toast
          </Button>
        </div>
        <Toaster {...args} />
